...
export default class extends React.PureComponent {
  render() {
    return (
      <svg className="menu__icon  menu__icon--projects" viewBox="-10 -10 52 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <g id="Canvas" transform="translate(-19 -1055)">
          <g id="icon--folder">
            <use xlinkHref="#projects__path0_fill" transform="translate(19 1055)" fill="#fff"/>
          </g>
        </g>
        <Filter hash="projects" />
        <defs>
